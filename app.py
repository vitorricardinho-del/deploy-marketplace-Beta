...
def admin_mural():
    ...
    try:
        ...
        return render_template('admin.html', pedidos=todos, faturamento=faturamento, total_denuncias=total_den, total_vendas=total_vendas_realizadas, stats_categorias=stats_categorias, mais_acessados=mais_acessados, top_1=top_1, ultimos=todos[:5], pendentes=pendentes_cont, parceiros_food=parceiros_pendentes)
    except Exception as e:
